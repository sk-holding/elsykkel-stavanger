        ...
        <div className={styles.header_inner}>
          <div>
            ...
            <p>
              ...
              kvalitetsutstyr for friluftsliv over hele Norge. Fra starten har
              vi forpliktet oss til å tilby et bredt spekter av produkter og
              tjenester, samtidig som vi opprettholder høyeste standard for
